	...
	let menu = '<div class="loader" id="pageloader"></div><div class="menu_content">' +
        ...
        '<div class="side_menu">' +
            ...
            '<ul class="navbar-nav" id="additionalMenu">' +
                '<li class="nav-item">' +
                    '<a class="nav-link" data-id="dashboardpage" id="dash" aria-current="page" href="dashboard.html">Dashboard</a>' +
                '</li>' +
                ...
                '</li>' +
                '<li class="nav-item">' +
                    '<a class="nav-link" data-id="standortezuweisen" id="standorte-zuweisen" href="standorte-zuweisen.html">Standorte zuweisen</a>' +
                '</li>' +
                '<li class="nav-item">' +
                    '<a class="nav-link" data-id="bestelltoolpage" id="bestelltool" href="bestelltool.html">Neuinstallationen</a>' +
                '</li>' +
            '</ul>' +
...
jQuery(document).ready(function(){
    jQuery(document).on("click",".nav-link",function(event){
        ...
        var nav_id = jQuery(this).attr("data-id");
        jQuery(".page_component").addClass("hidecomponent");
        jQuery("#"+nav_id).removeClass("hidecomponent");
    });
});