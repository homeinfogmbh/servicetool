...
function getDefaultDisplayURL(system) {
	...
	let lte = "";
	if (system.deployment.connection == "UMTS" || system.deployment.connection == "LTE" || system.deployment.connection == "WLANLTE")
		lte = "&lte=true";
    return getDefaultCustomerBaseURL(system.deployment.customer.abbreviation.toString()) + "/?system=" + system.id + "&deployment=" + system.deployment.id + address + "&customer=" + system.deployment.customer.id + "&ddbos=true" + lte;
}
